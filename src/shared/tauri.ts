...
export const api = {
  ...
  setAgentBubbleLayout: (visibleAgentCount: number, expanded: boolean, summaryVisible = true) =>
    invoke<void>("set_agent_bubble_layout", { visibleAgentCount, expanded, summaryVisible }),
